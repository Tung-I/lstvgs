...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/rubble_citygs_coarse_v5/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/rubble_citygs_coarse_v5/slurm_%j.log
...
RESULT_DIR="$WORK_DIR/lctvgs/results/rubble_citygs_coarse_v5"
# Use v3 coarse PLY as starting point (981k well-distributed Gaussians)
INIT_PLY="$WORK_DIR/lctvgs/results/rubble_citygs_coarse_v3/ply/point_cloud_29999.ply"
