...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/rubble_citygs_blocks_v6/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/rubble_citygs_blocks_v6/slurm_%j.log
...
COARSE_DIR="$WORK_DIR/lstvgs/results/rubble_citygs_coarse_v5"
BLOCK_DIR="$WORK_DIR/lstvgs/results/rubble_citygs_blocks_v6"
MERGE_DIR="$WORK_DIR/lstvgs/results/rubble_citygs_merged_v6"
