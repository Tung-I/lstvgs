...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/building_citygs_coarse/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/building_citygs_coarse/slurm_%j.log
...
RESULT_DIR="$WORK_DIR/lctvgs/results/building_citygs_coarse"
