...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/rubble_citygs_coarse_v3/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/rubble_citygs_coarse_v3/slurm_%j.log
...
RESULT_DIR="$WORK_DIR/lstvgs/results/rubble_citygs_coarse_v3"
