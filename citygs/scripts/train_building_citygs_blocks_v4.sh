#!/bin/bash
#SBATCH --job-name=building-citygs-blocks-v4
#SBATCH --partition=gpu
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=48:00:00
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/building_citygs_blocks_v4/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/building_citygs_blocks_v4/slurm_%j.log
...
COARSE_DIR="$WORK_DIR/lctvgs/results/building_citygs_coarse_v4"
BLOCK_DIR="$WORK_DIR/lctvgs/results/building_citygs_blocks_v4"
MERGE_DIR="$WORK_DIR/lctvgs/results/building_citygs_merged_v4"
...
echo "=== Building CityGS block training v4 started: $(date) ==="
