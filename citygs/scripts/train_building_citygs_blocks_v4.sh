...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/building_citygs_blocks_v4/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/building_citygs_blocks_v4/slurm_%j.log
...
COARSE_DIR="$WORK_DIR/lstvgs/results/building_citygs_coarse_v4"
BLOCK_DIR="$WORK_DIR/lstvgs/results/building_citygs_blocks_v4"
MERGE_DIR="$WORK_DIR/lstvgs/results/building_citygs_merged_v4"
