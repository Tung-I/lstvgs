...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/building_citygs_blocks_v7/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/building_citygs_blocks_v7/slurm_%j.log
...
BLOCK_DIR="$WORK_DIR/lstvgs/results/building_citygs_blocks_v7"
MERGE_DIR="$WORK_DIR/lstvgs/results/building_citygs_merged_v7"
