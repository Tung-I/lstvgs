...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/rubble_citygs_blocks_v7/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/rubble_citygs_blocks_v7/slurm_%j.log
...
BLOCK_DIR="$WORK_DIR/lctvgs/results/rubble_citygs_blocks_v7"
MERGE_DIR="$WORK_DIR/lctvgs/results/rubble_citygs_merged_v7"
