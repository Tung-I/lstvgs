...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/rubble_citygs_blocks/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lctvgs/results/rubble_citygs_blocks/slurm_%j.log
...
COARSE_DIR="$WORK_DIR/lctvgs/results/rubble_citygs_coarse"
BLOCK_DIR="$WORK_DIR/lctvgs/results/rubble_citygs_blocks"
MERGE_DIR="$WORK_DIR/lctvgs/results/rubble_citygs_merged"
