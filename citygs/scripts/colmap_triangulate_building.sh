...
#SBATCH --output=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/colmap_building/slurm_%j.log
#SBATCH --error=/work/pi_rsitaram_umass_edu/tungi/lstvgs/results/colmap_building/slurm_%j.log
